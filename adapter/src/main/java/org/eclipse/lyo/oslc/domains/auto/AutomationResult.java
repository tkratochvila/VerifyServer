    ...
    implements IAutomationResult
{
    ...
    // End of user code
    private HashSet<Measure> contribution = new HashSet<Measure>();
    ...
    */
    ...
    public void addContribution(final Measure contribution)
    {
    ...
    @OslcRange({EmsDomainConstants.MEASURE_TYPE})
    @OslcReadOnly(false)
    public Set<Measure> getContribution()
    {
    ...
    // End of user code
    public void setContribution(final Set<Measure> contribution )
    {
