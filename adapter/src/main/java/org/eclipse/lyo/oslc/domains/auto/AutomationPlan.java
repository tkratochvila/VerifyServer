    ...
    implements IAutomationPlan
{
    ...
    // End of user code
    private HashSet<ParameterDefinition> parameterDefinition = new HashSet<ParameterDefinition>();
    ...
    // Start of user code attributeAnnotation:timeSpent
    // End of user code
    ...
    */
    @Deprecated
    public AutomationPlan(final String serviceProviderId, final String automationPlanId)
           throws URISyntaxException
    {
        this (constructURI(serviceProviderId, automationPlanId));
    ...
    */
    @Deprecated
    public static URI constructURI(final String serviceProviderId, final String automationPlanId)
    {
    ...
    */
    @Deprecated
    public static Link constructLink(final String serviceProviderId, final String automationPlanId , final String label)
    {
        return new Link(constructURI(serviceProviderId, automationPlanId), label);
    }
    ...
    */
    @Deprecated
    public static Link constructLink(final String serviceProviderId, final String automationPlanId)
    {
        return new Link(constructURI(serviceProviderId, automationPlanId));
    }
    ...
    // Start of user code getterAnnotation:timeSpent
    // End of user code
    @OslcName("timeSpent")
    @OslcPropertyDefinition(For_reqDomainConstants.FORREQ_NAMSPACE + "timeSpent")
    @OslcDescription("Time spent on each requirement in seconds")
    @OslcOccurs(Occurs.ZeroOrOne)
    @OslcValueType(ValueType.String)
    @OslcReadOnly(false)
    public String getTimeSpent()
    {
        // Start of user code getterInit:timeSpent
        // End of user code
        return timeSpent;
    }
    ...
    // Start of user code setterAnnotation:timeSpent
    // End of user code
    public void setTimeSpent(final String timeSpent )
    {
        // Start of user code setterInit:timeSpent
        // End of user code
        this.timeSpent = timeSpent;
    
        // Start of user code setterFinalize:timeSpent
        // End of user code
    }
    ...
    @Deprecated
    static public String timeSpentToHtmlForCreation (final HttpServletRequest httpServletRequest)
    {
        String s = "";
    
        // Start of user code "Init:timeSpentToHtmlForCreation(...)"
        // End of user code
    
        s = s + "<label for=\"timeSpent\">timeSpent: </LABEL>";
    
        // Start of user code "Mid:timeSpentToHtmlForCreation(...)"
        // End of user code
    
        s= s + "<input name=\"timeSpent\" type=\"text\" style=\"width: 400px\" id=\"timeSpent\" >";
        // Start of user code "Finalize:timeSpentToHtmlForCreation(...)"
        // End of user code
    ...
    public String parameterDefinitionToHtml()
    {
        ...
        try {
            s = s + "<ul>";
            for(ParameterDefinition next : parameterDefinition) {
                s = s + "<li>";
    ...
    @Deprecated
    public String timeSpentToHtml()
    {
        String s = "";
    
        // Start of user code timeSpenttoHtml_mid
        // End of user code
        ...
        try {
            if (timeSpent == null) {
                ...
                s = s + timeSpent.toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    
        // Start of user code timeSpenttoHtml_finalize
        // End of user code
