...
import hon.oslc.automation.resources.For_reqDomainConstants;
    ...
    implements IAutomationRequest
{
    ...
    // End of user code
    private HashSet<Link> instanceShape = new HashSet<Link>();
    // Start of user code attributeAnnotation:serviceProvider
    // End of user code
    private HashSet<Link> serviceProvider = new HashSet<Link>();
    ...
    // Start of user code attributeAnnotation:verifyServerResponse
    // End of user code
    private String verifyServerResponse;
    ...
    /**
    * @deprecated Use the methods in class {@link hon.oslc.automation.AdapterResourcesFactory} instead.
    */
    @Deprecated
    public AutomationRequest(final String serviceProviderId, final String automationRequestId)
           throws URISyntaxException
    {
        this (constructURI(serviceProviderId, automationRequestId));
    ...
    */
    @Deprecated
    public static URI constructURI(final String serviceProviderId, final String automationRequestId)
    {
    ...
    */
    @Deprecated
    public static Link constructLink(final String serviceProviderId, final String automationRequestId , final String label)
    {
        return new Link(constructURI(serviceProviderId, automationRequestId), label);
    }
    ...
    */
    @Deprecated
    public static Link constructLink(final String serviceProviderId, final String automationRequestId)
    {
        return new Link(constructURI(serviceProviderId, automationRequestId));
    }
    ...
    // Start of user code getterAnnotation:verifyServerResponse
    // End of user code
    @OslcName("verifyServerResponse")
    @OslcPropertyDefinition(For_reqDomainConstants.FORREQ_NAMSPACE + "verifyServerResponse")
    @OslcOccurs(Occurs.ExactlyOne)
    @OslcValueType(ValueType.String)
    @OslcReadOnly(false)
    public String getVerifyServerResponse()
    {
        // Start of user code getterInit:verifyServerResponse
        // End of user code
        return verifyServerResponse;
    }
    ...
    // Start of user code setterAnnotation:verifyServerResponse
    // End of user code
    public void setVerifyServerResponse(final String verifyServerResponse )
    {
        // Start of user code setterInit:verifyServerResponse
        // End of user code
        this.verifyServerResponse = verifyServerResponse;
    
        // Start of user code setterFinalize:verifyServerResponse
        // End of user code
    }
    ...
    @Deprecated
    static public String verifyServerResponseToHtmlForCreation (final HttpServletRequest httpServletRequest)
    {
        String s = "";
    
        // Start of user code "Init:verifyServerResponseToHtmlForCreation(...)"
        // End of user code
    
        s = s + "<label for=\"verifyServerResponse\">verifyServerResponse: </LABEL>";
    
        // Start of user code "Mid:verifyServerResponseToHtmlForCreation(...)"
        // End of user code
    
        s= s + "<input name=\"verifyServerResponse\" type=\"text\" style=\"width: 400px\" id=\"verifyServerResponse\" >";
        // Start of user code "Finalize:verifyServerResponseToHtmlForCreation(...)"
        // End of user code
    ...
    @Deprecated
    public String verifyServerResponseToHtml()
    {
        String s = "";
    
        // Start of user code verifyServerResponsetoHtml_mid
        // End of user code
    
        try {
            if (verifyServerResponse == null) {
                s = s + "<em>null</em>";
            }
            else {
                s = s + verifyServerResponse.toString();
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    
        // Start of user code verifyServerResponsetoHtml_finalize
        // End of user code
