...
,
            new PrefixDefinition(EmsDomainConstants.ESTIMATION_AND_MEASUREMENT_NAMSPACE_PREFIX, new URI(EmsDomainConstants.ESTIMATION_AND_MEASUREMENT_NAMSPACE))
,
            new PrefixDefinition(FoafDomainConstants.FOAF_NAMSPACE_PREFIX, new URI(FoafDomainConstants.FOAF_NAMSPACE))
,
            new PrefixDefinition(For_reqDomainConstants.FORREQ_NAMSPACE_PREFIX, new URI(For_reqDomainConstants.FORREQ_NAMSPACE))
,
